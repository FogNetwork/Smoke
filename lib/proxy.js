const http = require('http'),https = require('https'),fetch = require('node-fetch'),{ JSDOM } = require('jsdom'),regex = /\s+(href|src)=['"](.*?)['"]/gi,regex2 = /\s*(location.href|location)\s+=\s+['"](.*?)['"]/g,mime = require('mime')
